...
date: "2026-04-11"
categories: [circuits, paper-notes]
draft: false
---

Notes on [Elhage, Nanda, Olsson et al. (2021)](https://transformer-circuits.pub/2021/framework/index.html). This paper kicked off the Anthropic transformer circuits thread. This is one of the first serious attempts to reverse engineer what's happening inside a transformer, and more importantly, it develops the *mathematical language* for doing so. The results are on tiny attention only models, but the framework (residual streams, QK/OV circuits, path expansions) became the foundation for everything that followed in mechanistic interpretability.
